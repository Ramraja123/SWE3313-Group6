...
public class WaiterLogin {
	...
	public static String[] username1 = {"Ramraja","Alex","Kyle"};//Usernames
	public static String[] password1 = {"Rayamajhi","Kiwus","Ambrose"};//Passwords
	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				   ...
				   if(username2.equals(username1[0]) || username2.equals(username1[1]) || username2.equals(username1[2])
					&& password2.equals(password1[0]) || password2.equals(password1[1]) || password2.equals(password1[2])) {
					   
					   frame.setVisible(false);
					   WaiterView.main(null);
				   }
				   else{
